...
| 数据域 | 主源 | 备用或交叉验证 |
| --- | --- | --- |
| 实时报价、盘口、逐笔 | Magic TDX | 腾讯、新浪 |
| 日线、分钟线 | Magic TDX | 腾讯、新浪、百度 |
| 财务三表 | 新浪 | 无可验证备用时显式失败 |
| 个股和行业研报 | 东财 | PDF 只保留真实 URL |
| 一致预期 | 同花顺 | 东财研报预测作为独立证据 |
| 个股、板块资金流 | 东财 | 其他源只作独立交叉验证 |
| 龙虎榜和资本数据 | 东财 | 无完整席位时降级为已验证事实 |
| 涨跌停池和强势原因 | 东财、同花顺 | 两批证据分别保留 |
| 个股新闻 | 东财、迁入 Magic 的新浪新闻 | 按来源独立批次 |
| 全球快讯 | 财联社、通过准入的独特新闻源 | 不合格源删除 |
| 公告和互动问答 | 巨潮 | 交易所公告为后续独立源 |
| 语义搜索 | i问财 | 缺授权 Key 时 `Authentication` |

Magic TDX 是实时行情主源。公开网页 Provider 只承担其已验证的数据域，
不得冒充五秒实时报价 SLA。
