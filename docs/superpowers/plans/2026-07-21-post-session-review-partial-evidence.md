...
- [ ] **Step 1: Register BR-140 before code**
...
- [ ] **Step 2: Add RED tests for the complete state table**
...
- [ ] **Step 4: Implement the minimal types**
...
- [ ] **Step 3: Implement task state and due filtering**
...
- [ ] **Step 4: Wire scheduler and strict CLI**
...
- [ ] **Step 1: Write RED candidate tests with TEST_CODE fixtures**
...
- [ ] **Step 3: Implement per-record isolation**
...
- [ ] **Step 3: Implement accepted/rejected collections**
...
- [ ] **Step 3: Return typed statuses before I/O**
...
- [ ] **Step 1: Add RED provider and component tests**
...
- [ ] **Step 3: Add strict real fallback and partial component assembly**
