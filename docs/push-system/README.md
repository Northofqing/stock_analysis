...
- [W15当前记录查询接线计划](../superpowers/plans/2026-09-10-readiness-current-record-query.md)：下一开发任务，复用v3/store/完整集合重读，集中拒绝历史head与查询期间漂移；不新增候选CLI冒充同一认证快照的最终消费者，尚无本任务实现验收结果。
