...
pub fn boms() -> &'static [BomNode] {
    ...
    CACHE.get_or_init(|| {
        vec![
            // ─── 新能源车 ───
            BomNode {
                chain: String::from("新能源车"),
                segment: String::from("锂矿"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.7,
                margin_pct: 0.18,
                lead_days: 30,
                source: String::from("Industry"),
                confidence: 0.7,
            },
            BomNode {
                chain: String::from("新能源车"),
                segment: String::from("正极材料"),
                direction: BomDirection::Midstream,
            ...
            BomNode {
                chain: String::from("新能源车"),
                segment: String::from("电池"),
                direction: BomDirection::Midstream,
                elasticity_score: 0.9,
                margin_pct: 0.25,
                lead_days: 10,
                source: String::from("Industry"),
                confidence: 0.8,
            ...
            BomNode {
                chain: String::from("新能源车"),
                segment: String::from("整车"),
                direction: BomDirection::Downstream,
            ...
            // ─── 半导体 ───
            BomNode {
                chain: String::from("半导体"),
                segment: String::from("硅片"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.6,
                margin_pct: 0.20,
                lead_days: 45,
            ...
            // ─── 光伏 ───
            BomNode {
                chain: String::from("光伏"),
                segment: String::from("硅料"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.9,
                margin_pct: 0.25,
                lead_days: 30,
            ...
            BomNode {
                chain: String::from("光伏"),
                segment: String::from("电站"),
                direction: BomDirection::Downstream,
                elasticity_score: 0.4,
                margin_pct: 0.10,
                lead_days: 30,
                source: String::from("Industry"),
                confidence: 0.5,
            ...
            // ─── 医药 ───
            BomNode {
                chain: String::from("医药"),
                segment: String::from("原料药"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.6,
                margin_pct: 0.15,
                lead_days: 30,
            ...
            // ─── 消费电子 ───
            BomNode {
                chain: String::from("消费电子"),
                segment: String::from("芯片"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.7,
                margin_pct: 0.20,
                lead_days: 20,
            ...
            // ─── 军工 (新增) ───
            BomNode {
                chain: String::from("军工"),
                segment: String::from("原材料"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.5,
                margin_pct: 0.12,
                lead_days: 60,
            ...
            // ─── 银行 (新增, 高股息/利率敏感) ───
            BomNode {
                chain: String::from("银行"),
                segment: String::from("国有大行"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.7,
                margin_pct: 0.30,
                lead_days: 5,
            ...
            // ─── 计算机/软件 (新增) ───
            BomNode {
                chain: String::from("计算机"),
                segment: String::from("硬件"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.5,
                margin_pct: 0.12,
                lead_days: 30,
            ...
            // ─── 通信 (新增) ───
            BomNode {
                chain: String::from("通信"),
                segment: String::from("光模块"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.8,
                margin_pct: 0.25,
                lead_days: 15,
            ...
            // ─── 化工 (新增) ───
            BomNode {
                chain: String::from("化工"),
                segment: String::from("原料"),
                direction: BomDirection::Upstream,
                elasticity_score: 0.7,
                margin_pct: 0.20,
                lead_days: 30,
...
pub fn find_bom_node(chain: &str, segment: &str) -> Option<&'static BomNode> {
    boms()
        .iter()
        .find(|n| n.chain == chain && n.segment == segment)
}
