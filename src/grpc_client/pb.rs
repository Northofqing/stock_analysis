//! Frozen LocalBridgeV1 magic.market.v1 contract; ExternalV1 lives in external_pb.
...
/// Descriptor emitted by the same build invocation as the generated Local types.
pub const FILE_DESCRIPTOR_SET: &[u8] =
    include_bytes!(concat!(env!("OUT_DIR"), "/local_bridge_v1/descriptor.bin"));
...
pub mod magic {
    pub mod market {
        pub mod v1 {
            include!(concat!(
                env!("OUT_DIR"),
                "/local_bridge_v1/magic.market.v1.rs"
            ));
        }
    }
}
